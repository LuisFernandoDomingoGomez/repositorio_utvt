            ...
            <div class="content">
                <div class="intro-y flex flex-col sm:flex-row items-center">
                    ...
                    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                        <a class="btn btn-primary shadow-md mr-2" href="{{ route('tematicas.create') }}">Agregar</a>
                        <div class="dropdown ml-auto sm:ml-0">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="{{ route('tematicas.create') }}" class="dropdown-item"> <i data-lucide="tematicas" class="w-14 h-14 mr-2"></i> Agregar Tematica </a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="intro-y box p-5 mt-5">
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start flex-wrap">
                        <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto" action="{{ route('tematicas.index') }}" method="GET">
                        ...
                        <div class="flex mt-5 sm:mt-0">
                            <a href="{{ route('tematica.pdf') }}" class="btn btn-outline-secondary w-1/2 sm:w-auto mr-2">
                            ...
                            <div class="dropdown w-1/2 sm:w-auto">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a id="tabulator-export-pdf" href="{{ route('tematica.downloadPdf') }}"
                                                class="dropdown-item"> <i class="fas fa-file-pdf w-4 h-4 mr-2"></i>Export PDF</a>
                                        </li>
                                        <li>
                                            <a id="tabulator-export-xlsx" href="{{ route('tematica.export') }}"
                    ...
                    <div class="overflow-x-auto scrollbar-hidden">
                        <div class="overflow-x-auto">
                            <table class="table mt-5">
                                ...
                                <tbody>
                                    @php
                                        $i = ($tematicas->currentPage() - 1) * $tematicas->perPage() + 1;
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-report__action w-56">
                                            <div class="flex justify-center items-center">
                                                <!-- <a class="flex items-center mr-3" href="{{ route('tematicas.show', $tematica->id) }}">
                                                    <i data-lucide="eye" class="w-4 h-4 mr-1"></i>
                                                </a> -->
                                                <a class="flex items-center mr-3" href="{{ route('tematicas.edit', $tematica->id) }}">
                                                    <i data-lucide="check-square" class="w-4 h-4 mr-1"></i>
                                                </a>
                                                <form action="{{ route('tematicas.destroy', $tematica->id) }}" method="POST" class="formEliminar">
                                                    @csrf
                                                    @method('DELETE')
        ...
        Array.prototype.slice.call(forms)
            .forEach(function(form) {
                form.addEventListener('submit', function(event) {
                    ...
                    Swal.fire({
                        title: '¿Deseas eliminar la tematica?',
                        icon: 'info',
