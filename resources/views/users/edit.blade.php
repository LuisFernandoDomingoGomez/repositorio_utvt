                    ...
                    <ul class="menu__sub-open">
                        <li>
                            <a href="side-menu-light-dashboard-overview-1.html" class="menu menu--active">
                                ...
                                <div class="menu__title"> Overview 1 12 </div>
                            </a>
                        </li>
                        <li>
                            ...
                            <ul class="">
                                ...
                                <li>
                                    <a href="side-menu-light-tabulator.html" class="menu">
                                        <div class="menu__icon"> <i data-lucide="zap"></i> </div>
                                        <div class="menu__title">Tabulator xs</div>
                                    </a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="search-result__content">
                        ...
                        <div class="mb-5">
                            <a href="" class="flex items-center">
                                <div
                                    class="w-8 h-8 bg-success/20 text-success flex items-center justify-center rounded-full">
                    ...
                    <ul class="side-menu__sub-open">
                        ...
                        <li>
                            <a href="" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> lista de cursos</div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('users.index') }}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> Usuarios administrativos </div>
                            </a>
                        </li>
                        <li>
                ...
                <div class="intro-y box p-5 mt-5">
                    <div class="flex flex-col sm:flex-row sm:items-end xl:items-start">
                        <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                            listada de usuarios con su rol respectivo
                        </form>
                    </div>
                                ...
                                <form action="" method="POST" >
                                    ...
                                    <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                                        <div class="intro-y col-span-12 sm:col-span-6">
                                            ...
                                            <input id="input-wizard-1" type="text" name="nombre" value="" class="form-control" placeholder="nombre completo">
                                        </div>
                                        <div class="intro-y col-span-12 sm:col-span-6">
                                            <label for="input-wizard-2" class="form-label">Telefono</label>
                                            <input id="input-wizard-2" type="number" name="telefono"value="" class="form-control" placeholder="telefono">
                                        </div>
                                        <div class="intro-y col-span-12 sm:col-span-6">
                                            <label for="input-wizard-3" class="form-label">Apellidos Paternos</label>
                                            <input id="input-wizard-3" type="text" class="form-control" name="apellidosP" value=""placeholder="Important Meeting">
                                        </div>
                                        <div class="intro-y col-span-12 sm:col-span-6">
                                            <label for="input-wizard-4" class="form-label">Correo Electronico</label>
                                            <input id="input-wizard-4" type="email" class="form-control" name="correo" value=""placeholder="example@gmail.com">
                                        </div>
                                        <div class="intro-y col-span-12 sm:col-span-6">
                                            <label for="input-wizard-5" class="form-label">Apellidos Maternos</label>
                                            <input id="input-wizard-5" type="text" class="form-control" name="apellidosM"value="" placeholder="Apellidos Maternos">
                                        </div>
                                        <div class="intro-y col-span-12 sm:col-span-6">
