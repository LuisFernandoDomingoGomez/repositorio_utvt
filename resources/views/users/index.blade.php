                    ...
                    <ul class="">
                        <li>
                            <a href="" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> tabla de cursos </div>
                            </a>
                        </li>
                        <li>
                        ...
                        <div class="dropdown ml-auto sm:ml-0">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="{{ route('users.create') }}" class="dropdown-item"> <i data-lucide="users" class="w-14 h-14 mr-2"></i> Agregar nuevo Usuario </a>
                                    </li>
