...
<head>
    ...
    <title>Publicaciones Pendientes | Inicio</title>
    <!-- BEGIN: CSS Assets-->
            ...
            <ul class="scrollable__content py-2">
                ...
                <li>
                    ...
                    <ul class="">
                        ...
                        <li>
                            <a href="{{ route('estados.index') }}" class="menu">
        ...
        <div class="h-full flex items-center">
            ...
            <nav aria-label="breadcrumb" class="-intro-x h-[45px] mr-auto">
                <ol class="breadcrumb breadcrumb-light">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Publicaciones Pendientes</li>
                </ol>
            </nav>
            <!-- END: Breadcrumb -->
                ...
                <li>
                    ...
                    <ul class="">
                        ...
                        <li style="margin-left: 7px;">
                            <a href="{{ route('estados.index') }}" class="side-menu">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table mt-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td><img src="{{asset($recurso->imagen)}}" style="width: 50px; height: 50px;"></td>
                                    <td>{{ $recurso->name }}</td>
                                    ...
                                    <td class="table-report__action w-56">
                                        <div class="flex justify-center items-center">
                                            ...
                                            <a class="flex items-center mr-3" href="{{ route('recurso.edit', $asignatura->id) }}">
