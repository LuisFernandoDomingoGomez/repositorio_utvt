    ...
    <div class="mobile-menu md:hidden">
        <div class="mobile-menu-bar">
            <a href="" class="flex mr-auto">
                <img class="w-12" src="dist/images/utvt_white.png">
            </a>
    ...
    <div
        ...
        <div class="h-full flex items-center">
            ...
            <a href="" class="logo -intro-x hidden md:flex xl:w-[180px] block">
                <span class="logo__text text-white text-lg ml-1"></span>
                <img class="logo__image w-20" src="dist/images/utvt_white.png">
            </a>
            <!-- END: Logo -->
            <!-- BEGIN: Breadcrumb -->
                    ...
                    <ul class="">
                        <li>
                            <a href="" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> usuarios incriptos </div>
                            </a>
                        </li>
                    </ul>
                </li>
                        ...
                        <div class="dropdown ml-auto sm:ml-0">
                            ...
                            <div class="dropdown-menu w-40">
                                <ul class="dropdown-content">
                                    <li>
                                        <a href="{{ route('roles.create') }}" class="dropdown-item"> <i
                                                data-lucide="user-plus" class="w-14 h-14 mr-2"></i> Agregar nuevo Rol
                                        </a>
                                    </li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-report__action w-56">
                                                <div class="flex justify-center items-center">
                                                    ...
                                                    @can('borrar-rol')
                                                        {!! Form::open(['method' => 'PUT', 'route' => ['roles.destroy', $role->id], 'class' => 'formEliminar']) !!}
