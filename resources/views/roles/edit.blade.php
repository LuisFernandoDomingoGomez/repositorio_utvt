...
<body class="py-5 md:py-0">
    ...
    <div class="flex overflow-hidden">
            ...
            <ul>
                <li>
                    ...
                    <ul class="side-menu__sub-open">
                        <li>
                            <a href="{{ route('roles.index') }}" class="side-menu side-menu--active">
                        ...
                        <li>
                            <a href="" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> lista de usuarios </div>
                            </a>
                        </li>
                        <li>
        ...
        <div class="content">
            <div class="content">
                <div class="intro-y flex flex-col sm:flex-row items-center mt-100">
                    <h2 class="text-lg font-medium mr-auto">
                        vista de roles
                    </h2>
                </div>
                <!-- BEGIN: HTML Table Data -->
<!-- /// cambio en el meotodo PATCH O METODO PUT -->
